...
public class ItemReciclavel
{



    public ItemReciclavel(string nome, int valorItem, SpriteRenderer spriteItemRodape, SpriteRenderer cestaLixo, GameObject containerItem, Text qtdItem)
    {
        Nome = nome;
